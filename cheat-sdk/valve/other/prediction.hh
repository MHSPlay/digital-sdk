...
public:
    ...
    VFUNC( void( __thiscall* )( void*, c_vec3& ),
           set_local_view_angles( c_vec3& angles ), 13,
           angles
        );

    VFUNC( void( __thiscall* )( void*, c_player*, double ),
           check_moving_ground( c_player* player, const double frame_time ), 18,
           player, frame_time
        );

    VFUNC( void( __thiscall* )( void*, c_player*, c_user_cmd*, i_move_helper*, void* ),
           setup_move( c_player* player, c_user_cmd* cmd, i_move_helper* move_helper, void* move_data ), 20,
           player, cmd, move_helper, move_data
        );

    VFUNC( void( __thiscall* )( void*, c_player*, c_user_cmd*, void* ),
           finish_move( c_player* player, c_user_cmd* cmd, void* move_data ), 21,
           player, cmd, move_data
        );
