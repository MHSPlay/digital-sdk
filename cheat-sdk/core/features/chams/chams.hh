...
class c_chams final {
    ...
    static i_material* create_material( std::string_view material_name, std::string_view shader_type, std::string_view material_data );
...
public:
	...
	bool draw_model( i_model_render* const model_render, void* edx, void* context, draw_model_state_t& state,
                     c_model_render_info& info, matrix_t* bones );
};
